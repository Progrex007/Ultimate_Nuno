        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-20 flex items-center gap-6">
          <a href="#" className="flex items-center gap-3 shrink-0" aria-label="Home">
            ...
            <div className="text-[11px] leading-tight uppercase tracking-[0.16em]">
              <div className="font-semibold text-[12px]">NUNO BRIZIDO</div>
        ...
        <div className="relative z-10 h-full w-full">
          <div className="mx-auto max-w-5xl px-6 h-full flex flex-col items-center justify-center text-white text-center">
            ...
            <h1 className="mt-6 font-serif text-3xl md:text-5xl lg:text-[56px] leading-[1.15] drop-shadow-sm">
              Nuno Brizido — Private Client Real Estate
            </h1>
            <p className="mt-3 text-sm md:text-base opacity-90 max-w-2xl">
              Luxury property advisory in Johannesburg & Pretoria East. High‑discretion, results‑driven representation.
            </p>
  ...
  return (
    <section id="about" className="py-28 px-6">
      <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-[420px,1fr] gap-12 lg:gap-16 items-center">
        <img src="https://images.pexels.com/photos/1704488/pexels-photo-1704488.jpeg" alt="Nuno Brizido headshot" className="w-full h-[560px] object-cover rounded-[28px]" />
        <div>
          <h2 className="font-serif text-4xl md:text-5xl">About Nuno Brizido</h2>
          <p className="mt-4 text-lg text-neutral-700 leading-relaxed">
            Nuno represents discerning buyers and sellers across Johannesburg & Pretoria East. With a reputation for
  ...
  return (
    <section id="authority" className="py-28 px-6 bg-neutral-50">
      <div className="mx-auto max-w-6xl">
        <h2 className="font-serif text-4xl md:text-5xl text-center">Authority, Engineered</h2>
      ...
      <div className="mi mi-section">
        <div className="mi-container">
          ...
          <div className="mi-grid mi-grid-3">
            <article className="mi-card">
              ...
              <div className="mi-content">
                ...
                <div className="mi-meta"><span>By Nuno Brizido</span><span className="mi-dot"/><span>5 min read</span><span className="mi-dot"/><span>Sep 2025</span></div>
            ...
            <article className="mi-card">
              ...
              <div className="mi-content">
                ...
                <div className="mi-meta"><span>By Nuno Brizido</span><span className="mi-dot"/><span>4 min read</span><span className="mi-dot"/><span>Sep 2025</span></div>
            ...
            <article className="mi-card">
              ...
              <div className="mi-content">
                ...
                <div className="mi-meta"><span>By Nuno Brizido</span><span className="mi-dot"/><span>6 min read</span><span className="mi-dot"/><span>Sep 2025</span></div>
          ...
          <div className="mi-row-actions">
            ...
            <a className="mi-ghost mi-primary" href="https://medium.com/" target="_blank" rel="noopener noreferrer">Visit Nuno on Medium</a>
          </div>
        </div>
      </div>
    </section>
...
function TestimonialsSection(){
  const slides = [
    { text: "Nuno's understanding of the luxury market is unparalleled. He secured our R15M Waterfall property in a highly competitive environment, handling every detail with absolute professionalism and discretion.", author: "James & Sarah Mitchell", title: "Entrepreneurs, Steyn City Residents" },
    { text: "Working with a StatusForge certified professional made all the difference. Nuno's market intelligence and network access gave us opportunities we never would have found elsewhere.", author: "Dr. Michael Khumalo", title: "Specialist Surgeon, Sandton" },
    { text: "The level of service and expertise exceeded every expectation. From initial consultation to final transfer, Nuno managed our R20M acquisition with remarkable efficiency and insight.", author: "Maria & Carlos Santos", title: "International Executives" },
  ];
    ...
    <section id="contact" className="py-28 px-6 bg-neutral-900 text-white">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
          ...
          <ContactCard title="Email" value="nuno@example.com" href="mailto:nuno@example.com"/>
...
// ===================== FOOTER (50vh) =====================
function Footer(){
  const year = new Date().getFullYear(); const company = "NUNO BRIZIDO"; const brandTag = "The Brizido Estate Co";
  const phoneDisplay = "(+27) 555-0199"; const phoneHref = "tel:+275550199"; const email = "nuno@example.com";
      ...
      <div className="mx-auto max-w-7xl min-h-[50vh] flex flex-col justify-between">
        <div className="pt-12 md:pt-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="md:col-span-3"><div className="inline-flex items-baseline gap-2"><div className="text-2xl tracking-[0.2em]">NUNO</div><div className="h-5 w-[2px] bg-neutral-300"/><div className="text-sm tracking-[0.24em] uppercase">NB</div></div></div>
